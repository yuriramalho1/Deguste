...
public class NumeroExtensoUtil {
	 ...
	 */
	public NumeroExtensoUtil(BigDecimal dec) {
		this();
		setNumber(dec);
	}
	 ...
	 *            valor para colocar por extenso
	 */
	public NumeroExtensoUtil(double dec) {
		this();
		setNumber(dec);
	}
	...
	public static void main(String[] args) {
		...
		NumeroExtensoUtil teste = new NumeroExtensoUtil(new BigDecimal(args[0]));
